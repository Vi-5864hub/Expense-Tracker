             ...
             return Room.databaseBuilder(
                 ...
                 fun InitBasicData(context: Context){
                     CoroutineScope(Dispatchers.IO).launch {
                         ...
                         dao.insertExpenses(ExpenseEntity(1,"Salary",5000.40, System.currentTimeMillis(),"Salary","Income"))
                         dao.insertExpenses(ExpenseEntity(2,"Paypal",2000.50, System.currentTimeMillis(),"Paypal","Income"))
                         dao.insertExpenses(ExpenseEntity(3,"Netflix",100.43, System.currentTimeMillis(),"Netflix","Expense"))
